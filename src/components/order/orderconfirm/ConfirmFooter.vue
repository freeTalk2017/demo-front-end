...
export default {
  ...
  methods: {
    ...
    callPay: function () {
      ...
      top.location.href = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxa1378048216955b0&redirect_uri=http://www.makeiteasy.xin/trade/check&response_type=code&scope=snsapi_base&state=1#wechat_redirect'
    }
  }
}
</script>
